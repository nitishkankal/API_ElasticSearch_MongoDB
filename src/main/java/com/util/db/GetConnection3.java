...
final public class GetConnection3 {

	// use Uses JNDI and Datasource 
	public Connection getJNDIConnection() {
		
		//java:/jboss/datasources/1@pp_in_house
		String DATASOURCE_CONTEXT = "java:/jboss/datasources/TheNewApp"; 
		//String DATASOURCE_CONTEXT = "java:/jboss/datasources/pp_in_house"; 
