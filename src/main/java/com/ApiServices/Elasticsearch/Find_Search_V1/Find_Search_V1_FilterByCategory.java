...
public class Find_Search_V1_FilterByCategory implements Serializable {
	...
	public Response getByID(@ApiParam(value = "query 1 keywords type: String", required = true) @DefaultValue("") @QueryParam("query1") String query1,
		...
		String json = Find_Search_V1_FilterByCategory.curlToJsonString(query1, query2, key, value);
		//System.out.println(json);
		
		try {
			postResponse = Find_Search_V1_FilterByCategory.doPostRequest("http://192.168.23.10:9200/it_com_goods_20180919/_search", json);
