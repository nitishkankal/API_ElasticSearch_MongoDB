...
public class Find_Search_V1_SearchProduct implements Serializable {
	...
	@ApiOperation(value = "Search a product/ a category/ a seller", notes = "1. Can search as follows:\r\n" + 
			"     1.1 Product name ; product_name\r\n" + 
			"     1.2 Category name ; categories_name.lv1 - categories_name.lv7\r\n" + 
			"     1.3 Seller name ; seller_name") // Specific
	...
	public Response getByID(@ApiParam(value = "query 1 keywords type: String", required = true) @DefaultValue("") @QueryParam("query1") String query1,
		...
		String json = Find_Search_V1_SearchProduct.curlToJsonString(query1, query2);
		//System.out.println(json);
		
		try {
			postResponse = Find_Search_V1_SearchProduct.doPostRequest("http://192.168.23.10:9200/it_com_goods_20180919/_search", json);
	...
	static String curlToJsonString(String query1, String query2) {
				...
				+ "\"minimum_should_match\":1}},\"size\":1000}";	
