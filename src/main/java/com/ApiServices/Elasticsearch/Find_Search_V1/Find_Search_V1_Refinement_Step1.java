...
public class Find_Search_V1_Refinement_Step1 implements Serializable {
	...
	@GET
	@Path("/Refinement_Step1")
	@Produces("application/json,application/xml")
	@ApiOperation(value = "Retrieve  Refinement Tags", notes = "Logic : result contains user's query in \"product_name\" or \"seller_name\" or \"product_description\" or "
			+ "\"product_variant\" or \"categories_name.lv1 - categories_name.lv7\" fields AND user can click to each refinement tag button to see result from combining"
			+ " user's keyword ad refinement tags keyword.") // Specific
	...
	public Response getByID(@ApiParam(value = "query 1 keywords type: String", required = true) @DefaultValue("") @QueryParam("query1") String query1,
		...
		String json = Find_Search_V1_Refinement_Step1.curlToJsonString(query1, query2);
		//System.out.println(json);
		
		try {
			postResponse = Find_Search_V1_Refinement_Step1.doPostRequest("http://192.168.23.10:9200/it_com_goods_20180919/_search", json);
	...
	static String curlToJsonString(String query1, String query2) {
		...
		return	"{\"query\":{\"bool\":{\"should\":[{\"multi_match\":{\"minimum_should_match\":\"25%\",\"type\":\"cross_fields\","
				...
				+ "\"minimum_should_match\":1}},\"size\":1000,\"aggs\":{\"count\":{\"terms\":{\"field\":\"product_name.keyword\",\"size\":10}}}}";
