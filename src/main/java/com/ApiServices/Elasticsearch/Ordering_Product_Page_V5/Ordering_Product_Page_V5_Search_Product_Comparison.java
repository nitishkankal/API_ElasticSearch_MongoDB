...
public class Ordering_Product_Page_V5_Search_Product_Comparison implements Serializable {
	...
	@GET
	@Path("/Search_Product_Comparison")
	@Produces("application/json,application/xml")
	@ApiOperation(value = " users search product for comparison on specific category.  ", notes = "Logic : results must come from \"categories_name.lv2.keyword\" "
	...
	public Response getByID(@ApiParam(value = "query 1 keywords type: String", required = true) @DefaultValue("") @QueryParam("query1") String query1,
			...
			@ApiParam(value = "Product category level type: String", required = true) @DefaultValue("categories_name.lv2.keyword") @QueryParam("filter_level") String key,
			@ApiParam(value = "Fillter keyword type: String", required = true) @DefaultValue("") @QueryParam("filter_Keyword") String value) {

		
		
		String postResponse = null;
		String json = Ordering_Product_Page_V5_Search_Product_Comparison.curlToJsonString(query1, query2, key, value);
		//System.out.println(json);
		
		try {
			postResponse = Ordering_Product_Page_V5_Search_Product_Comparison.doPostRequest("http://192.168.23.10:9200/it_com_goods_20180919/_search", json);
	...
	static String curlToJsonString(String query1, String query2, String key, String value) {
		...
		return "{\"query\":{\"bool\":{\"should\":[{\"multi_match\":{\"minimum_should_match\":\"25%\",\"type\":\"cross_fields\","
				+ "\"query\":\""+query1+"\",\"fields\":[\"product_name\",\"seller_name\",\"product_description\",\"product_variant\"],\"_name\":\"cross\"}},"
