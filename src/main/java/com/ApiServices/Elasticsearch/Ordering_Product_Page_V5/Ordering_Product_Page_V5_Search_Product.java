...
public class Ordering_Product_Page_V5_Search_Product implements Serializable {
	...
	@ApiOperation(value = " users search for product", notes = "Logic : result contains user's query in \"product_name\" or \"seller_name\" or \"product_description\" or \"product_variant\" fields.") // Specific
	...
	public Response getByID(@ApiParam(value = "query 1 keywords type: String", required = true) @DefaultValue("") @QueryParam("query1") String query1,
		...
		String json = Ordering_Product_Page_V5_Search_Product.curlToJsonString(query1, query2);
		//System.out.println(json);
		
		try {
			postResponse = Ordering_Product_Page_V5_Search_Product.doPostRequest("http://192.168.23.10:9200/it_com_goods_20180919/_search", json);
	...
	static String curlToJsonString(String query1, String query2) {
		...
		return	 "{\"query\":{\"bool\":{\"should\":[{\"multi_match\":{\"minimum_should_match\":\"25%\",\"type\":\"cross_fields\",\"query\":\""+query1+"\","
				...
				+ "\"query\":\""+query2+"\",\"fields\":[\"product_name\",\"seller_name\",\"product_description\",\"product_variant\"],"
				+ "\"_name\":\"fuzziness\"}}],\"minimum_should_match\":1}},\"size\":1000}";
