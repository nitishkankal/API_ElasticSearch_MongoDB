...
public class Ordering_Product_Page_V5_Filtering_New_Used_Product implements Serializable {
	...
	@GET
	@Path("/Filtering_New_Used_Product")
	@Produces("application/json,application/xml")
	@ApiOperation(value = " users filter product by product condition.  ", notes = "Logic :results must come from \"product_condition.keyword\" "
			+ "field AND contains user's query in \"product_name\" or \"seller_name\" or \"product_description\" or \"product_variant\" fields.") // Specific
	...
	public Response getByID(@ApiParam(value = "query 1 keywords type: String", required = true) @DefaultValue("") @QueryParam("query1") String query1,
			...
			@ApiParam(value = "Fillter keyword for product condition type: String", required = true) @DefaultValue("") @QueryParam("filter_Keyword") String value) {

		
		
		String postResponse = null;
		String json = Ordering_Product_Page_V5_Filtering_New_Used_Product.curlToJsonString(query1, query2 , value);
		//System.out.println(json);
		
		try {
			postResponse = Ordering_Product_Page_V5_Filtering_New_Used_Product.doPostRequest("http://192.168.23.10:9200/it_com_goods_20180919/_search", json);
	...
	static String curlToJsonString(String query1, String query2,  String value) {
		...
		return "{\"query\":{\"bool\":{\"should\":[{\"multi_match\":{\"minimum_should_match\":\"25%\",\"type\":\"cross_fields\",\"query\":\""+query1+"\","
				+ "\"fields\":[\"product_name\",\"seller_name\",\"product_description\",\"product_variant\"],\"_name\":\"cross\"}},"
				+ "{\"multi_match\":{\"minimum_should_match\":\"25%\",\"type\":\"best_fields\",\"fuzziness\":\"AUTO\",\"prefix_length\":3,"
				+ "\"query\":\""+query2+"\",\"fields\":[\"product_name\",\"seller_name\",\"product_description\",\"product_variant\"],\"_name\":\"fuzziness\"}}],"
				+ "\"filter\":{\"term\":{\"product_condition.keyword\":\""+value+"\"}},\"minimum_should_match\":1}},\"size\":1000}";
