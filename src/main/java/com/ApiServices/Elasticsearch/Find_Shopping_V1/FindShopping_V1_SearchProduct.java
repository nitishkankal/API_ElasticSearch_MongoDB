...
public class FindShopping_V1_SearchProduct implements Serializable {
	...
	public Response getByID(@ApiParam(value = "query 1 keywords type: String", required = true) @DefaultValue("") @QueryParam("query1") String query1,
		...
		String json = FindShopping_V1_SearchProduct.curlToJsonString(query1, query2);
		//System.out.println(json);
		
		try {
			postResponse = FindShopping_V1_SearchProduct.doPostRequest("http://192.168.23.10:9200/it_com_goods_20180919/_search", json);
