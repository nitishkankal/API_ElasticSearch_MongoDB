...
public class My_Influence_V1_Search_Product_In_Catalog implements Serializable {
	...
	@GET
	@Path("/Search_Product_In_Catalog")
	@Produces("application/json,application/xml")
	@ApiOperation(value = "users search for product in each influencer catalog. ", notes = "results must come from \"seller_id\" field AND contains user's query in \"product_name\" fields.\r\n" + 
			"\r\n" + 
	...
	public Response getByID(@ApiParam(value = "query 1 keywords type: String", required = true) @DefaultValue("") @QueryParam("query1") String query1,
		...
		String json = My_Influence_V1_Search_Product_In_Catalog.curlToJsonString(query1, query2);
		//System.out.println(json);
		
		try {
			postResponse = My_Influence_V1_Search_Product_In_Catalog.doPostRequest("http://192.168.23.10:9200/it_com_goods_20180919/_search", json);
	...
	static String curlToJsonString(String query1, String query2) {
		...
		return	"{\"query\":{\"bool\":{\"must\":[{\"match\":{\"product_name\":{\"query\":\""+query1+"\",\"fuzziness\":\"AUTO\",\"prefix_length\":3,\"minimum_should_match\":\"25%\"}}}],\"filter\":{\"term\":{\"seller_id\":"+query2+"}}}},\"size\":1000}";
