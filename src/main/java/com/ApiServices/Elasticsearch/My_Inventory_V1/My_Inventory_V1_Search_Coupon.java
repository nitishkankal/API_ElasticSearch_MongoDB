...
public class My_Inventory_V1_Search_Coupon implements Serializable {
	...
	@ApiOperation(value = "users search for conpon ", notes = " Logic : result contains user's query in \"coupon_name\" or \"seller_name\" fields.") // Specific
	...
	public Response getByID(@ApiParam(value = "query 1 keywords type: String", required = true) @DefaultValue("") @QueryParam("query1") String query1,
		...
		String json = My_Inventory_V1_Search_Coupon.curlToJsonString(query1, query2);
		//System.out.println(json);
		
		try {
			postResponse = My_Inventory_V1_Search_Coupon.doPostRequest("http://192.168.23.10:9200/coupon_20180919/_search", json);
	...
	static String curlToJsonString(String query1, String query2) {
		...
		return	"{\"query\":{\"bool\":{\"should\":[{\"multi_match\":{\"minimum_should_match\":\"25%\",\"type\":\"cross_fields\","
				...
				+ "\"query\":\""+query2+"\",\"fields\":[\"coupon_name\",\"seller_name\"],\"_name\":\"fuzziness\"}}],\"minimum_should_match\":1}},\"size\":1000}";
